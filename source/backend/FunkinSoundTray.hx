...
/**
 * The sound tray from V-Slice/the base game.
 * Wouldn't say this is the best way of implementing this, but hey it works.
 * And yes, this also supports the mod folders
 */
