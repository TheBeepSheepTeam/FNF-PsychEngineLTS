...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[""],
			["Psych Engine LTS Teams"],
			["charlesisfeline",		"charles",		"the one guy keeping the engine alive",					"https://github.com/charlesisfeline",	"444444"],
			[""],
			...
			["EliteMasterEric",		"mastereric",		"Secondary Programmer of\nFriday Night Funkin'",					"https://x.com/EliteMasterEric",	"FFBD40"],
			["evilsk8r",			"evilsk8r",			"Artist of Friday Night Funkin'",							"https://x.com/evilsk8r",			"5ABD4B"],
			["kawaisprite",			"kawaisprite",		"Main Composer of Friday Night Funkin'",							"https://x.com/kawaisprite",		"378FC7"],
			[""],
